...
public class CheckStockBoImpl extends WareHouseControlBoImpl implements CheckStockBo{
	 ...
	 * 不使用盘点计划，直接开始盘点
	 * @param positionId
	 * @param checkPlanId(checkPlanId/null)
	 * @param operator操作员ID
	 */
	@Transactional
	 ...
	 * @param list
	 * @param checkId盘点Id
	 * @param checkTime盘点次数  (一次/二次)
	 *          
	 */
	public void addCheckSnapData(
			List<StorageCheckSnapDataDetail> list,int checkId,String checkTime) {
		...
		if(!checkTime.equals(ConstantStorageCheckCheckTime.FIRST_CHECK)&&!checkTime.equals(ConstantStorageCheckCheckTime.SECOND_CHECK)){
	 ...
	 * @return true/false
	 */
	private  <T extends Comparable<T>> boolean compare(List<StorageCheckSnap> a, List<StorageCheckSnap> b){
		// private  <T extends Comparable<T>> boolean compare(List<StorageCheckSnap> a, List<StorageCheckSnap> b){
	 ...
	 * @param amount
	 */
	private void addCheckDiffAdjust(Integer operator, String memo,
			Integer checkId, Integer skuId, Integer amount) {
	...
	public List<StorageCheckSnap> findCheckSnapData(Integer checkId,String checkTime) {
		...
		if(!ConstantStorageCheckCheckTime.FIRST_CHECK.equals(checkTime)&&!ConstantStorageCheckCheckTime.SECOND_CHECK.equals(checkTime)){
