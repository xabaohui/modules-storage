...
public class CheckStockBoImplTest {
	...
	public void testCompareDiff() {
		...
		checkStockBo.addCheckSnapData(list, check.getCheckId(), ConstantStorageCheckCheckTime.FIRST_CHECK);

		// 比较
		List<StorageCheckDiffReaultDetail> listReault = checkStockBo.compareDiff(check.getCheckId(),
